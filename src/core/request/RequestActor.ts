import { Actor, AsyncActor, AsyncStage, IActorOpt, IAsyncDerived } from "../store";
...
export class RequestActor<TReq = IRequestOpts, TRespBody = any, TError = IStatusError> extends AsyncActor<
  TReq,
